...
const (
	RoleService_List_FullMethodName   = "/sso.v1.RoleService/List"
	RoleService_Get_FullMethodName    = "/sso.v1.RoleService/Get"
	RoleService_Create_FullMethodName = "/sso.v1.RoleService/Create"
	RoleService_Update_FullMethodName = "/sso.v1.RoleService/Update"
	RoleService_Delete_FullMethodName = "/sso.v1.RoleService/Delete"
)
...
type RoleServiceClient interface {
	List(ctx context.Context, in *PaginatedListRequest, opts ...grpc.CallOption) (*ListRolesResponse, error)
...
func (c *roleServiceClient) List(ctx context.Context, in *PaginatedListRequest, opts ...grpc.CallOption) (*ListRolesResponse, error) {
...
type RoleServiceServer interface {
	List(context.Context, *PaginatedListRequest) (*ListRolesResponse, error)
...
func (UnimplementedRoleServiceServer) List(context.Context, *PaginatedListRequest) (*ListRolesResponse, error) {
...
func _RoleService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).List(ctx, req.(*PaginatedListRequest))
	}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sso.v1.RoleService",
